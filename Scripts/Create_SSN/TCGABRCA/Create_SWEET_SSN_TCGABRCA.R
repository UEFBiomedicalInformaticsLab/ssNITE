...
# Script to prepare SSN using SWEET (sample-specific-weighted correlation network) for TCGA-BRCA samples
...
if(!dir.exists("IOFiles/Create_SSN/TCGABRCA/SWEET/")){dir.create("IOFiles/Create_SSN/TCGABRCA/SWEET/", recursive = TRUE)}
...
network <- create_SWEET_net( gene_expr = rnaSeq_vst,
                             IO_path = "IOFiles/Create_SSN/TCGABRCA/SWEET/",
                             sweet_k = 0.1,
...
write_parquet( x = network,
               sink = "IOFiles/Create_SSN/TCGABRCA/SWEET/SWEET_SSN__DA_TCGA__DT_BreastCancer.parquet",
               compression = "lz4" )

system("rm -r IOFiles/Create_SSN/TCGABRCA/SWEET/SWEET_edges_tmp/")
gc()
