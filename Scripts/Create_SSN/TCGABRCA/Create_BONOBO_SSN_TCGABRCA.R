...
# Script to prepare SSN using BONOBO (Bayesian Optimized sample-specific Networks Obtained By Omics data) for TCGA-BRCA samples
...
if(!dir.exists("IOFiles/Create_SSN/TCGABRCA/BONOBO/")){dir.create("IOFiles/Create_SSN/TCGABRCA/BONOBO/", recursive = TRUE)}
...
network <- create_BONOBO_net( gene_expr = rnaSeq_vst,
                              IO_path = "IOFiles/Create_SSN/TCGABRCA/BONOBO/", 
...
write_parquet( x = network,
               sink = "IOFiles/Create_SSN/TCGABRCA/BONOBO/BONOBO_SSN__DA_TCGA__DT_BreastCancer.parquet",
               compression = "lz4" )

system("rm -r IOFiles/Create_SSN/TCGABRCA/BONOBO/BONOBO_edges_tmp/")
gc()
