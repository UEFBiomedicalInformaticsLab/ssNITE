...
# Script to prepare SSN using SWEET (sample-specific-weighted correlation network) for TCGA-BRCA samples [sparse mode]
...
if(!dir.exists("IOFiles/Create_SSN/TCGABRCA/SWEETsparse/")){dir.create("IOFiles/Create_SSN/TCGABRCA/SWEETsparse/", recursive = TRUE)}
...
source("Scripts/Functions/SWEET/Functions_SWEET__main.R")

network <- create_SWEET_net( gene_expr = rnaSeq_vst,
                             IO_path = "IOFiles/Create_SSN/TCGABRCA/SWEETsparse/",
                             sweet_k = 0.1,
                             sweet_sparsify = TRUE,
                             n_cores = 10,
                             n_jobs = 3,
...
write_parquet( x = network,
               sink = "IOFiles/Create_SSN/TCGABRCA/SWEETsparse/SWEETsparse_SSN__DA_TCGA__DT_BreastCancer.parquet",
               compression = "lz4" )

system("rm -r IOFiles/Create_SSN/TCGABRCA/SWEETsparse/SWEET_edges_tmp/")
gc()
